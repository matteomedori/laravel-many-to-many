...
<body>
    <div id="app">
        ...
        <header class="navbar sticky-top  navbar-dark bg-dark flex-md-nowrap p-2 shadow">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.projects.index' ? 'bg-info' : '' }}"
